  ...
  return (
    <Box component={"footer"} sx={FOOTER_STYLE}>
      ...
      <Typography paragraph={true} sx={PARAGRAPH_STYLE}>
        <Box component={"span"}>About this website:</Box> built with React & Next.js (App Router &
        Server Actions), Typescript, Material UI, Framer Motion, React Email & Resend, Vercel
        Hosting
      </Typography>
    </Box>
  );
